...
// URL Logo Sekolah sesuai permintaan user
const SCHOOL_LOGO_URL = "https://bptikp-my.sharepoint.com/:i:/g/personal/didiksubroto2019_bptikpjateng_org/IQC08yjq9onNRLro_YVKtdpuAfp4GIUp_-gHGJk7MN5NIYI?e=gvbfY4&download=1";
      ...
      <div className="md:hidden sticky top-0 z-20 shadow-md no-print">
          ...
          <div className="bg-white dark:bg-paperDark border-b dark:border-gray-700 p-3 flex justify-between items-center">
            <div className="flex items-center gap-3">
               {/* Menggunakan Logo Sekolah menggantikan foto user */}
               <img src={SCHOOL_LOGO_URL} alt="Logo Sekolah" className="w-10 h-10 object-contain" />
